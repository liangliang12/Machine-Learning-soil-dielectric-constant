...
model_input_path = r'...\SscRetrieval_RealSM.plk'
...
X = data[['real','moisture','frequency','Sandy', 'Clay', 'rou_s', 'rou_b']]
...
X = {'real':[16.9],'moisture':[0.2], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
