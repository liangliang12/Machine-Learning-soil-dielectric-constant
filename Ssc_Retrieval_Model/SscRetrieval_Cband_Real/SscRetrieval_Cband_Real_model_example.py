...
# real:      imaginary part of soil dielectric constant
...
model_input_path = r'...\SscRetrieval_Cband_Real.plk'
...
X = data[['real', 'frequency','Sandy', 'Clay', 'rou_s', 'rou_b']]
...
X = {'real':[16.9], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
