...
# Moisture:  The imaginary part of soil dielectric constant
...
model_input_path = r'...\SMRetrieval_Cband_RealSsc.plk'
...
X = data[['real', 'salinity', 'frequency','Sandy', 'Clay', 'rou_s', 'rou_b']]
...
X = {'real':[16.9],'salinity':[5], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
