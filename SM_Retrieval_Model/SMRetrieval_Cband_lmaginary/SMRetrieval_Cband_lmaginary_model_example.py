...
model_input_path = r'...\SMRetrieval_Cband_Imaginary.plk'
...
X = data[['imaginary', 'frequency','Sandy', 'Clay', 'rou_s', 'rou_b']]
...
X = {'imaginary':[9.9], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
