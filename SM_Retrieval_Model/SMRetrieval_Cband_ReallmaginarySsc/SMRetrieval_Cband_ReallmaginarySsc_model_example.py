...
model_input_path = r'...\SMRetrieval_Cband_RealImaginarySsc.plk'
...
X = {'real':[16.9],'imaginary':[9.9],'salinity':[0.2], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
