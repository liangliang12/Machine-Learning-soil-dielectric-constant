...
# this is an example about soil moisture content model
# model_input_path is the address of the data storage folder
model_input_path = r'...\SMRetrieval_Cband_ImaginarySsc.plk'
...
X = data[['imaginary', 'salinity', 'frequency','Sandy', 'Clay', 'rou_s', 'rou_b']]
...
X = {'imaginary':[9.9],'salinity':[10], 'frequency':[5.5],'Sandy': [0.46], 'Clay':[0.097], 'rou_s':[2.65], 'rou_b':[1.35]}
